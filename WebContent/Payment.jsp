...
<%
    ...
    if(cmd.equals("Insert")) 
    {
       		...
       		{	  
 				...
 				%>
              <form method="post" action="Payment.jsp" id="myform">
                       ...
                       %>
						...
						<select name="customerID" id="roomcustomer">
		 				<%
						while(re.next())
						{
					...
					$(document).ready(function() {
                     ...
                     <input type="text" name="IDInput" id= "inputID" ivalue=""/></div><br/>
